...
ActiveRecord::Schema.define(version: 2021_07_05_134621) do
  ...
  create_table "invitations", force: :cascade do |t|
    ...
    t.index ["sender_id", "recipient_id"], name: "index_invitations_on_sender_id_and_recipient_id", unique: true
